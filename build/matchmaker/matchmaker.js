...
class matchmaker {
    ...
    async server(ws, req) {
        ...
        socket.on(`${bote}-queue`, async (message) => {
        ...
        socket.on(`${bote}-status`, async (message) => {
        ...
        async function Queued(players, playlist) {
        ...
        async function SessionAssignment(playlist) {
